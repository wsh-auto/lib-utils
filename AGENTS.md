...
PRIMARY: SKILL.md (3.4k) - How to use; self-contained
...
hackmd: https://hackmd.io/CK-C5TeaRjybEtpSryFX-Q
---
...
- `query`
- `installDeathWatch` - daemon vitals: event-loop p99, GC p99, rejection/exception counters, and active handles by type
...
|--------|---------|-----|-----|
| per-site | 2 / 1h | `file:line` (caller stack frame) | Caps a single hot site (one bad daemon line) |
| per-project | 5 / 1h | logger root (`ops-sysguard`) | Aggregates across sites; bounds cascade noise |
...
# lib-utils (45.3k)
## Documentation (4.4k)
- [@SKILL.md (3.4k)](https://hackmd.io/l07wsxmXQBiIND0y36i2Ig)
- @CONTRIBUTING.md (600)
- @package.json (500)
...
- [@../dev-typescript/SKILL.md (10k)](https://hackmd.io/MQmOpQtPSoWcCVjYaWdHSA)
  - [@../dev-core/SKILL.md (11k)](https://hackmd.io/CK-C5TeaRjybEtpSryFX-Q)
  - [@SKILL.md (3k)](https://hackmd.io/l07wsxmXQBiIND0y36i2Ig)
- @../lib-1password/SKILL.md (2k)
- [@../lib-log/SKILL.md (7k)](https://hackmd.io/MEsItP9cS7yVldf73XkzBw)
